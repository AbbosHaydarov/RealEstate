			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "55d3dfe0-2793-31f6-cfb9-b82c818ada21",
							"code": "PDS_UsrPrice",
							"caption": "#ResourceString(PDS_UsrPrice)#",
							"dataValueType": 32
						},
						{
							"id": "3d45c4ae-3dcc-2375-ed6d-70b2e71c67ce",
							"code": "PDS_UsrArea",
							"caption": "#ResourceString(PDS_UsrArea)#",
							"dataValueType": 32
						},
						{
							"id": "b5440bf7-8528-137e-9e83-fc60ebc95dcb",
							"code": "PDS_UsrType",
							"caption": "#ResourceString(PDS_UsrType)#",
							"dataValueType": 10
						},
						{
							"id": "82232314-d493-6e52-a41c-61f36e61961b",
							"code": "PDS_UsrOfferType",
							"caption": "#ResourceString(PDS_UsrOfferType)#",
							"dataValueType": 10
						},
						{
							"id": "d81ea53c-7b68-d05d-8f93-5ed7ed2e628a",
							"code": "PDS_UsrCommission",
							"caption": "#ResourceString(PDS_UsrCommission)#",
							"dataValueType": 32
						},
						{
							"id": "f423f638-3af7-8395-8bb8-9ca4bd5d4362",
							"code": "PDS_UsrComment",
